...
import ListedLinks from "../../../common/navigation/components/ListedLinks";
  ...
  render() {
    return (
      <div id="content" className="animated fadeInUp">
        <div className="row">
          <BigBreadcrumbs
            items={["3D Printers", "Printers list"]}
            icon="fa fa-lg fa-fw fa-cube"
            className="col-xs-12 col-sm-7 col-md-7 col-lg-4"
          />
          <ListedLinks
            items={[{link: "#/printers/create-printer", color: "purple", icon: "glyphicon glyphicon-plus-sign", linkText: "Create new printer"}, {link: "#/printers/create-printer-category", color: "blue", icon: "glyphicon glyphicon-list", linkText: "Create printer category"}]}/>
        </div>
        <WidgetGrid>
          {/* row */}
          <div className="row">
