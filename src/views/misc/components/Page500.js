            ...
            <div className="row">
              <div className="col-sm-12">
                <div className="text-center error-box">
                  <h1 className="error-text tada animated">
                    <i className="fa fa-times-circle text-danger error-icon-shadow" />
                    Error 500
                  </h1>
                  ...
                  <p className="lead semi-bold">
                    ...
                    <br />
                    <small>
                      We are working hard to correct this issue. Please wait a
                      few moments and try your search again. <br /> In the
                      meantime, check out whats new on SmartAdmin:
                    </small>
                  </p>
